        ...
        <>
            ...
            <section className="page-shell section-pad">
                <motion.div
                    ...
                    className="bg-surface mx-auto grid max-w-4xl gap-8 overflow-hidden p-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center rounded-2xl border border-border shadow-sm"
                >
