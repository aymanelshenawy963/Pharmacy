    ...
    return (
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            {badges.map((badge, index) => (
                <div
                    key={badge.title}
                    className="bg-[rgb(var(--color-surface))] rounded-2xl border border-[rgb(var(--color-border))] shadow-sm flex items-center gap-3.5 p-4 transition-all duration-300 hover:shadow-sm animate-[fadeInUp_0.5s_cubic-bezier(0.16,1,0.3,1)_both]"
