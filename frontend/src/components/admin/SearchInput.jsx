                ...
                <AnimatePresence>
                    {value && (
                        <motion.button
                            ...
                            onClick={() => onChange('')}
                            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-md p-1 text-[rgb(var(--color-text-muted))] hover:text-[rgb(var(--color-text))] hover:bg-[rgb(var(--color-bg-subtle))] transition-colors min-w-[28px] min-h-[28px] flex items-center justify-center"
